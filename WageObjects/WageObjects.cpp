                    ...
                    int myClockNumber, float myWageRate, float myHours)
{
    ...
    // Before initializing the others, let's Convert myTaxState to uppercase if entered in lowercase
    ...
    hours = myHours;                   // input
    // A note about the line directly below: calcOverTimeHrs() is not a private method; it's a private 
    // member function. Member functions, whether they are private or public, can access other private 
    // members of the same class directly. So, there's no need for a getter function to access calcOverTimeHrs() 
...
// A note about these getters: For this function, they are used to actually get the values,
// Whether they are to be printed like this: "cout<<"\n First Name: "<< e.getFirstName();"
// As you will see right below these getters
...
void Employee::printEmployee(Employee e) {
    ...
    // cout statement with call to stateTax getter function
    cout <<"\n State Tax : $" <<  e.getStateTax();
    
    // cout statement with call to fedTax getter function
    cout <<"\n Federal Tax : $" <<  e.getFedTax();

    // cout statement with call to netPay getter function
    cout <<"\n Net Pay : $" <<  e.getNetPay();
