...
Most of the updates, compared to the WageObjects program, were in the last two functions: main and printEmployee. 

I also had to make sure to include the file stream file header:
